  ...
  const filterData = [
    {
      name: "gender",
      title: "Gender",
      icon: <FontAwesomeIcon icon={faUser} className="mr-2 text-gray-500" />,
      options: [
        { label: "Men", value: "men" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Brown", value: "brown", color: "bg-yellow-900" },
    ...
    },
    {
      ...
      options: [
        { label: "Urban Edge", value: "Urban Edge" },
        { label: "AlphaGear", value: "AlphaGear" },
        { label: "Elegant Co.", value: "Elegant Co." },
        { label: "Classic Line", value: "Classic Line" },
        { label: "StreetStyle", value: "StreetStyle" },
      ],
    },
    {
      name: "ratings",
